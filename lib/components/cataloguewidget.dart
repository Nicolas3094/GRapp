...
class _CatalogueWidget extends State<CatalogueWidget> {
  ...
  Widget descriptionBtnCat(Catalogue project) => TextButton(
        style: TextButton.styleFrom(
          ...
          minimumSize: Size(
              tablet || tabletland ? 125 : 110, tablet || tabletland ? 35 : 30),
  ...
  Widget verticalView(BuildContext context, int index, List<Imagen> imglist,
    ...
    return Column(
      ...
      children: [
        Container(
            //flex: tablet || tabletland ? 4 : 1,
            width: double.infinity,
            height: MediaQuery.of(context).size.height * (phone ? 0.3 : 0.4),
        ...
        if (_name != "catalogue")
          Container(
            padding: EdgeInsetsDirectional.fromSTEB(0, phone ? 10 : 0, 0, 20),
            child: Row(
